  ...
  <div class="rotate-wrapper">
    <transition name="frontCardRotate">
      <div class='card-content' v-show="showFlag">
        ...
        <div class='card-dot' :class="cardNumberIsActive">
          {{cardNumbersComputed | addSpace}}
        </div>
        <span class="card-name" :class="cardNameIsActive">
          {{cardNameComputed}}
        </span>
        <span class="valid-thru" :class="cardValidThruIsActive">
          valid thru
        </span>
        <span class="valid-thru-value" :class="cardValidThruIsActive">
...
export default {
  ...
  computed: {
    ...
    cardNumberIsActive: function () {
      return this.focusNum === 1 ? 'active' : ''
    },
    cardNameIsActive: function () {
      return this.focusNum === 2 ? 'active' : ''
    },
    cardValidThruIsActive: function () {
      return this.focusNum === 3 ? 'active' : ''
    }
  },
  components: {
    'v-background': () => import('components/cardBackground.vue')
  }
}
</script>
